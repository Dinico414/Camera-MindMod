...
import org.lineageos.mindone.aperture.ext.getOrCreate
...
class OverlaysRepository(private val context: Context) {
    ...
    private val rroResources = listOf(
        "org.lineageos.mindone.aperture.auto_generated_rro_product__",
        "org.lineageos.mindone.aperture.auto_generated_rro_vendor__",
    ).mapNotNull {
